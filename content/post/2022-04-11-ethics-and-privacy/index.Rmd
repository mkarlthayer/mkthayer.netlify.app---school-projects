...
```{r}
cases <- tribble(~Date, ~Mask, ~NoMask,
                       "2020-07-12",    26, 10,
                       "2020-07-13", 19.7, 9,
                       "2020-07-14", 19.7, 9.5,
                       "2020-07-15", 20, 9.8,
...
cases %>%
  ...
  geom_line(aes(y=NoMask, color = "lightblue")) +
  theme_bw() +
...
- Mask mandate counties had a higher 7-day rolling average of cases/per 100k than no-mask mandate counties in Kansas over the given time span
